...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="Mbbra001$", database="school"):
        self.host = host
        self.user = user
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """ This App is created during the practice of "Python" Feel Free to Modify and reuse the app
        """
